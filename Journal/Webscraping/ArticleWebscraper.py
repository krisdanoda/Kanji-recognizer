...
def add_to_dict(dict_data):
    ...
    dta = np.append(dta, driver.find_elements(By.CLASS_NAME,"body-text"))
    dta = np.append(dta, driver.find_elements(By.CLASS_NAME,"content--summary"))
    dta = np.append(dta, driver.find_elements(By.CLASS_NAME,"content--summary-more"))
...
base_url = 'https://www3.nhk.or.jp/news/html/20230427/k'
